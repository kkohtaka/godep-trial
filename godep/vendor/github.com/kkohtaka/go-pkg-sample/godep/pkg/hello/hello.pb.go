...
func (c *helloClient) Hello(ctx context.Context, in *HelloRequest, opts ...grpc.CallOption) (*HelloReply, error) {
	out := new(HelloReply)
	err := grpc.Invoke(ctx, "/hello.Hello/Hello", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
var fileDescriptor0 = []byte{
	...
	0x35, 0xb2, 0xe2, 0x62, 0x05, 0xab, 0x13, 0x32, 0x84, 0x31, 0x84, 0xf5, 0x20, 0x56, 0x22, 0x5b,
	0x21, 0x25, 0x88, 0x2a, 0x08, 0x34, 0x53, 0x89, 0x21, 0x89, 0x0d, 0xec, 0x2a, 0x63, 0x40, 0x00,
	0x00, 0x00, 0xff, 0xff, 0x20, 0xe1, 0x08, 0x3d, 0xa4, 0x00, 0x00, 0x00,
}
